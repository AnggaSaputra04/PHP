<header id="header">
    <div class="d-flex flex-column">
        ...
        <div class="profile">
            ...
            <h1 class="text-light"><a href="portfolio-details.php">Angga Saputra</a></h1>
        ...
        <nav id="navbar" class="nav-menu navbar">
            <ul>
                <li><a href="index.php?hal=section" class="nav-link scrollto active"><i class="bx bx-home"></i>
                        <span>Home</span></a></li>
